...
set userAccounts(accounts:AccountDto[]){
  ...
  this.httpClient.get<AccountDto[]>(this.baseUrl +'/account/'+ userId).pipe(take(1)).subscribe((res : AccountDto[])=>{
...
this.httpClient.post(this.baseUrl +'/account', createAccountDto).pipe(take(1)).subscribe((acc :any)=>{
